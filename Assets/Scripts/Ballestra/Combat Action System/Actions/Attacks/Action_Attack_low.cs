...
public class Action_Attack_low : ICombatAction // concrect implementantion of attack action
{
    ...
    public Action_Attack_low(NovaCharacterController character)
    {
        recieverCharacter = character;

        targetAnchor = recieverCharacter.GetComponent<Transform>().Find("Anchor").Find("Front").Find("FrontLow");
