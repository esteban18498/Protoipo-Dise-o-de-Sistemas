...
public class Action_Block_High : ICombatAction // concrect implementantion of void action to do nothing
{
    ...
    public Action_Block_High(NovaCharacterController character)
    {
        recieverCharacter = character;

        targetAnchor = recieverCharacter.GetComponent<Transform>().Find("Anchor").Find("Center").Find("R Block Top");
