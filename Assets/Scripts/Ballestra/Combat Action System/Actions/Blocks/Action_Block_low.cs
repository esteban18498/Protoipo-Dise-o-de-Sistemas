...
public class Action_Block_Low : ICombatAction // concrect implementantion of void action to do nothing
{
    ...
    public Action_Block_Low(NovaCharacterController character)
    {
        recieverCharacter = character;

        targetAnchor = recieverCharacter.GetComponent<Transform>().Find("Anchor").Find("Center").Find("R Block Low");
